...
API_ID = int(environ['API_ID' '27884083'])
API_HASH = environ['API_HASH' 'f41ef10f7e283ba0b6b18fac6fbe8226']
BOT_TOKEN = environ['BOT_TOKEN' '5904872028:AAG-FOMuGeN5dDpNWEcBV8aWYXnvP57U900']
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001839212555 -1001833597275').split()]
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001597329217'))
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '')).split()] yd
